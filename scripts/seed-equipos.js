...
const AREAS = [
  { name: 'Domingo', icon: '⛪', desc: 'Equipos que hacen posible cada reunión de domingo.', teams: [
  ...
  { name: 'Locales', icon: '🏛️', desc: 'Equipos que cuidan los espacios y la operativa de los domingos.', teams: [
  ...
  { name: 'Creativos', icon: '🎨', desc: 'Equipos que comunican y expresan creativamente la visión de la iglesia.', teams: [
  ...
  { name: 'Conexiones', icon: '🤝', image: '/img/areas/conexiones.jpg', desc: 'Ayuda a cada persona a sentirse bienvenida y encontrar su siguiente paso.', teams: [
  ...
  { name: 'Kids', icon: '🧒', desc: 'Comunidad para niños de 0 a 12 años, con reuniones cada domingo.', teams: [
  ...
  { name: 'Comunidades', icon: '👥', image: '/img/areas/comunidades.jpg', desc: 'Espacios para conectar, pertenecer y crecer juntos entre semana.', teams: [
  ...
  { name: 'Sisterhood', icon: '🌸', desc: 'Comunidad de mujeres de todas las generaciones.', teams: [
  ...
  { name: 'Jóvenes', icon: '⚡', desc: 'Comunidades para adolescentes y jóvenes, incluyendo Grupos de Conexión y eventos.', teams: [
    ['Youth', 'Comunidad para adolescentes de 12 a 18 años.'],
    ['PowerHouse', 'Comunidad para jóvenes de 18 a 30 años.'] ] },
  { name: 'Cuidado Pastoral', icon: '💛', desc: 'Acompañamiento espiritual en diferentes momentos de la vida.', teams: [
  ...
  { name: 'CityCare', icon: '🏙️', desc: 'Engloba la acción social de nuestra iglesia.', teams: [
  ...
  { name: 'Formaciones', icon: '📖', image: '/img/areas/formaciones.jpg', desc: 'Espacios para crecer en Biblia, fe y liderazgo.', teams: [
