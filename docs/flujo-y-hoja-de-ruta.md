...
| **Admin total** | Ve y gestiona todo, sin restricción: ciudades, equipos, usuarios y emails de cualquier ciudad, y el horario global de los resúmenes. |
| **Admin de ciudad** | Como el admin total, pero limitado a su ciudad: ve y toca sus solicitudes; gestiona equipos (cualquier campo, pero en ciudades solo puede tocar la suya); da de alta y gestiona seguimiento de Equipos/Bases/GC de su ciudad; edita los emails, pero solo el texto de su ciudad. No crea ciudades ni cambia el horario global. |
...
7. **Lista completa por email**, dos veces por semana (domingo a las 22:00 y jueves a las 8:00 por defecto, mismo horario para todas las ciudades, configurable solo por el admin total): a cada uno de seguimiento de Equipos, de Bases y de GC (por ciudad), su lista abierta en tres partes — nuevas desde el último envío, a quien toca hacer seguimiento (pasados 7 días sin novedad) y el resto, con los datos, cursos y si está **OK con Planning Center** de cada persona. Antes de cada envío se actualizan los cursos con Planning Center. Es la única vía por email — junto con el panel, donde cada uno ve su lista al día en todo momento.
...
5. Puede **borrar** solicitudes de su ciudad.

**Seguimiento de Bases** (ve, en toda su ciudad, a quien le falte Bases 1 o Bases 2 según Planning Center): llama para invitarle a apuntarse y pulsa **Contactar** para marcarlo — cada pulsación añade un contacto nuevo con su fecha (sin deshacer), así seguimiento de Equipos ve cuántas veces y cuándo, sin tener que preguntar. En vez de «OK con PCO» ve una columna **«Qué le falta»**, curso a curso: si de verdad no lo tiene, o si lo autodeclaró y Planning Center no lo confirma (aviso de actualizar el dato, con la nota de que puede que le faltara marcar la asistencia). No cambia el estado general de la solicitud ni puede borrarla (eso lo lleva seguimiento de Equipos o administración), pero sí puede dejar un comentario.

**Seguimiento de GC** (ve, en toda su ciudad, a quien ya tenga Bases 1 —autodeclarado cuenta— y le falte el GC según Planning Center): llama para ofrecérselo, con el mismo botón **Contactar**. Mismas posibilidades que seguimiento de Bases: ver su lista con «Qué le falta», marcar cada contacto y comentar.

Seguimiento de Equipos ve, junto a cada persona a la que le falte algo, cuántas veces y cuándo la han contactado seguimiento de Bases y/o de GC — así sabe si hace falta insistir o esperar antes de su propia llamada.
...
Pestaña **Emails**: un texto por ciudad (selector arriba), con vista previa, prueba y «Restaurar el original»; incluye también los avisos a administración cuando falta alguien de seguimiento de Equipos, de Bases o de GC. Los días y horas de la lista completa son globales y solo los cambia el admin total. Administración ve quién hace seguimiento de Equipos/Bases/GC de cada persona; exporta CSV (con la columna «OK con PCO», el motivo si no, quién hace seguimiento de Equipos/Bases/GC de cada uno, y cuántas veces y cuándo la han contactado Bases y GC).
