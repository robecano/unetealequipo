# Guía rápida · Únete al equipo

## ¿Qué es esto?
Un sistema que recoge a las personas que quieren **servir en un equipo** de la iglesia, para que quien corresponda —seguimiento de Equipos, de Bases o de GC— **les contacte** y les ayude con su siguiente paso.

## ¿Cómo entro?
**equipos.iglesiahillsong.com/panel** con **tu email** y la contraseña común (te la da coordinación en persona; no la compartas por escrito). Solo ves lo que te toca a ti.
...
Ves a **todos** los que se apuntan en tu ciudad, de cualquier equipo, tengan o no completados Bases 1, Bases 2 y GC.
1. **Esta semana:** llámala e invítala a visitar el equipo **el próximo domingo** → pulsa **Contacté**.
...
Si haces **seguimiento de Equipos o eres administración**, en su lugar ves si lo que consta cuadra con Planning Center:
- **Sí:** todo en orden.
...
- Si no quiere continuar, no insistas (seguimiento de Equipos puede marcar **No continúa**).
