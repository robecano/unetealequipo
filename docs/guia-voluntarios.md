# Guía rápida para líderes · Únete al equipo

## ¿Qué es esto?
Un sistema que recoge a las personas que quieren **servir en un equipo** de la iglesia, para que quien corresponda —líder de equipo, de Bases o de GC— **les llame** y les ayude con su siguiente paso.
...
Ves a **todos** los que se apuntan a tu equipo, tengan o no completados Bases 1, Bases 2 y GC.
...
- Si no quiere continuar, no insistas (el líder de equipo puede marcar **No continúa**).
